...
import 'package:endo_trainer/presentations/login/bloc/login_bloc.dart';
            ...
            child: Column(
              children: [
                    ...
                    Positioned(
                      ...
                      child: Padding(
                        padding: EdgeInsets.only(
                            bottom: 50, left: AppSizes.screenWidth * .05),
                        child: Text(
                ...
                Transform.translate(
                  ...
                  child: Padding(
                    padding: EdgeInsets.only(
                        left: AppSizes.screenWidth * .05,
                        right: AppSizes.screenWidth * .05),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Padding(
                          padding: EdgeInsets.only(
                              bottom: AppSizes.screenHeight * .008,
                                  ...
                                  Container(
                                      ...
                                      child: Transform.translate(
                                        ...
                                        child: CountryCodePicker(
                                          ...
                                          dialogSize: Size(AppSizes.screenWidth,
                            ...
                            child: BlocBuilder<LoginBloc, LoginState>(
                              builder: (context, state) {
                                return PrimaryButton(
                                  ...
                                  onTap: () {
                                    if (state is! LoginLoading) { // Prevent multiple taps while loading
                                      final loginBloc = context.read<LoginBloc>();
                                      context.read<LoginBloc>().add(
                                        LoginSubmitted(
                                          context: context,
                                          phone: "${loginBloc.countryCode}${phoneController.text.trim()}",
